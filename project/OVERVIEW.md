...
Fase 4  — Minecraft-Aware World Diffing             [~] Em andamento (diff por chunk, parser NBT completo, estatísticas de blocos/entidades/estruturas, mapa visual de chunks — falta cobrir entidades/estruturas/Nether-End no diff em si, ver PHASE.md)
